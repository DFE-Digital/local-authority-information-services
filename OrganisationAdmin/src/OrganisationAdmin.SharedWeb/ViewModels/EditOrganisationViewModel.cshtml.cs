...
namespace OrganisationAdmin.SharedWeb.ViewModels;

public class EditOrganisationViewModel : PageModel
{
    ...
    public Guid OrganisationTypeId { get; set; } = Guid.Empty;

    public Guid ContactId { get; set; } = Guid.Empty;

    public IEnumerable<SelectListItem> OrganisationTypeList { get; set; } = Enumerable.Empty<SelectListItem>();

    public Guid SelectedOrganisationType { get; set; } = Guid.Empty;

    public string OrganisationDescription { get; set; } = string.Empty;

    public Uri OrganisationLogoUrl { get; set; } = default!;

    public string OrganisationLogoAltText { get; set; } = string.Empty;

    public string OrganisationContactName { get; set; } = string.Empty;

    public string OrganisationContactEmail { get; set; } = string.Empty;
