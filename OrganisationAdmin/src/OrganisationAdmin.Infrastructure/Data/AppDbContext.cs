...
using OrganisationAdmin.SharedKernel;
...
public class AppDbContext : DbContext
{
  ...
  public DbSet<Organisation> OrganisationItems => Set<Organisation>();
  ...
  public override async Task<int> SaveChangesAsync(CancellationToken cancellationToken = new CancellationToken())
  {
    ...
    var guidEntitiesWithEvents = ChangeTracker.Entries<EntityBase<Guid>>()
        .Select(e => e.Entity)
        .Where(e => e.DomainEvents.Any())
        .ToArray();

    await _dispatcher.DispatchAndClearEvents(guidEntitiesWithEvents);
